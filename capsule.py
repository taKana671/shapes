...
class Capsule(Cylinder):
    """A class to creates a capsule.
       ...
       Args:
            radius (float): the radius of the capsule; must be greater than zero.
            inner_radius (float): must be 0 <= inner_radius <= radius.
            ...
            top_hemisphere (bool): True, a top hemisphere is created.
            bottom_hemisphere (bool): True, a bottom hemisphere is created.
